...
(* OASIS_START *)
(* DO NOT EDIT (digest: 14bd57219961f749e89a87de1a183271) *)
(*
...
let setup_t =
  {
       ...
       CustomPlugin.main
         {
            CustomPlugin.cmd_main =
              [
                 (OASISExpr.EBool true,
                   ("ocamlfind", ["install"; "lablgtk2"; "META"; "src/*.*"]))
              ];
            cmd_clean = [(OASISExpr.EBool true, None)];
            cmd_distclean = [(OASISExpr.EBool true, None)];
            };
     uninstall =
       CustomPlugin.main
         {
            CustomPlugin.cmd_main =
              [(OASISExpr.EBool true, ("ocamlfind", ["remove"; "lablgtk2"]))];
            cmd_clean = [(OASISExpr.EBool true, None)];
            cmd_distclean = [(OASISExpr.EBool true, None)];
            };
     clean =
