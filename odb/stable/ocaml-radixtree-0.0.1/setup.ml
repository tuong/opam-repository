...
(* OASIS_START *)
(* DO NOT EDIT (digest: e4276229ca2327c72b856d4d5be2ee92) *)
(*
...
let setup_t =
  {
     ...
     doc = [("api-radixtree", OCamlbuildDocPlugin.doc_build "src/")];
     ...
     clean_doc = [("api-radixtree", OCamlbuildDocPlugin.doc_clean "src/")];
     distclean = [];
     distclean_test =
       [
          ("main",
               ...
               Doc
                 ({
                     ...
                     },
                   {
                      ...
                      doc_install_dir = "$htmldir/radixtree";
                      doc_title = "API reference for RadixTree";
                      doc_authors = [];
                      doc_abstract = None;
                      doc_format = OtherDoc;
                      doc_data_files = [];
