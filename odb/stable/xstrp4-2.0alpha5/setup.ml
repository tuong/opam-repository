...
(* OASIS_START *)
(* DO NOT EDIT (digest: c3d700d795caf61ddaae887da86a3980) *)
(*
     ...
     package =
       {
          ...
          copyrights = [];
          maintainers = [];
          authors = ["Gerd Stolpmann"; "Hezekiah M. Carty"];
          homepage = None;
            ...
            [
               Library
                 ({
                   ...
                   {
                      lib_modules = ["Xstrp4"];
                      lib_internal_modules = ["Xstrp4_types"; "Xstrp4_lexer"];
                      lib_findlib_parent = None;
                      lib_findlib_name = Some "xstrp4";
                      lib_findlib_containers = [];
                      });
               Library
                 ({
                     cs_name = "xstrp4_batteries_quote";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = [];
                     },
                   {
                   ...
                   {
                      lib_modules = ["Xstrp4_batteries_quote"];
                      lib_internal_modules = ["Xstrp4_batteries"];
                      lib_findlib_parent = Some "xstrp4";
                      lib_findlib_name = Some "batteries_quote";
                      lib_findlib_containers = ["syntax"];
                      });
               Library
                 ({
                     cs_name = "xstrp4_here_quote";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = [];
                     },
                   {
                   ...
                   {
                      lib_modules = ["Xstrp4_here_quote"];
                      lib_internal_modules = [];
                      lib_findlib_parent = Some "xstrp4";
                      lib_findlib_name = Some "here_quote";
                      lib_findlib_containers = ["syntax"];
                      });
               Library
                 ({
                     cs_name = "xstrp4_batteries_strings";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = [];
                     },
                   {
                   ...
                   {
                      lib_modules = ["Xstrp4_batteries_strings"];
                      lib_internal_modules = ["Xstrp4_batteries"];
                      lib_findlib_parent = Some "xstrp4";
                      lib_findlib_name = Some "batteries_strings";
                      lib_findlib_containers = ["syntax"];
                      });
               Library
                 ({
                      ...
                      },
                   {
                      ...
                      lib_internal_modules = [];
                      lib_findlib_parent = Some "xstrp4";
                      lib_findlib_name = Some "here";
                      lib_findlib_containers = ["syntax"];
                      });
               Library
                 ({
                     cs_name = "xstrp4_strings";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = [];
                     },
                   {
                   ...
                   {
                      lib_modules = ["Xstrp4_strings"];
                      lib_internal_modules = [];
                      lib_findlib_parent = Some "xstrp4";
                      lib_findlib_name = Some "strings";
                      lib_findlib_containers = ["syntax"];
                      })
            ];
          plugins =
