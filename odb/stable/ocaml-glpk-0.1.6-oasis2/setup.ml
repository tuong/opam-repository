...
(* OASIS_START *)
(* DO NOT EDIT (digest: dae76c413e2d1b0676213458dbda74e0) *)
(*
     ...
     package =
       {
          ...
          homepage = None;
          synopsis = "OCaml bindings for GLPK";
          description = None;
          categories = [];
               ...
               Library
                 ({
                     ...
                     },
                   {
                      ...
                      bs_c_sources = ["glpk_stubs.c"];
                      bs_data_files = [];
                      bs_ccopt = [(OASISExpr.EBool true, [])];
                      bs_cclib = [(OASISExpr.EBool true, ["-lglpk"])];
