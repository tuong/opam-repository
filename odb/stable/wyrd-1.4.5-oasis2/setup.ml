...
(* OASIS_START *)
(* DO NOT EDIT (digest: 6e0d4a40dbc0017b4226b09c923ee7b6) *)
(*
       ...
       CustomPlugin.Build.main
         {
            ...
            cmd_distclean =
              [(OASISExpr.EBool true, Some (("make", ["distclean"])))];
            };
     test = [];
     doc = [];
     install =
     ...
     package =
       {
          ...
          homepage = Some "http://pessimization.com/software/wyrd";
          ...
          conf_custom =
            {
               ...
               post_command =
                 [(OASISExpr.EBool true, Some (("touch", ["setup.data"])))];
               };
