...
(* OASIS_START *)
(* DO NOT EDIT (digest: 2b5dbd9625bbd40b420bd4de295df2a2) *)
(*
     ...
     package =
       {
          ...
          homepage = Some "http://ocaml-posix-resource.forge.ocamlcore.org/";
          ...
          files_ab = ["src/POSIXResourceConfig.ml.ab"];
          sections =
            [
               Library
                 ({
                     cs_name = "posix_resource";
                     ...
                     },
                   {
                      ...
                      bs_c_sources = ["POSIXResource_stub.c"];
                      bs_data_files = [];
                   ...
                   {
                      lib_modules = ["POSIXResource"];
                      lib_internal_modules = ["POSIXResourceConfig"];
                 ...
                 ({cs_name = "test"; cs_data = PropList.Data.create (); },
                   {
                      ...
                      bs_build_depends =
                        [
                           InternalLibrary "posix_resource";
                           FindlibPackage
                             ("oUnit",
                               Some
