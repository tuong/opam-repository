...
(* OASIS_START *)
(* DO NOT EDIT (digest: abe893dfa18669d08cec66e981a22198) *)
(*
...
let setup_t =
  {
     ...
     build =
       CustomPlugin.Build.main
         {
            CustomPlugin.cmd_main =
              [(OASISExpr.EBool true, ("make", ["bcl"; "ncl"]))];
            cmd_clean = [(OASISExpr.EBool true, None)];
            cmd_distclean = [(OASISExpr.EBool true, None)];
            };
     test = [];
               ...
               Library
                 ({
                      ...
                      },
                   {
                      ...
                      lib_findlib_name = Some "json-wheel";
