...
external direct_dot :
  ...
  incx : int ->
  x : vec
  -> float = "lacaml_Sdot_stub_bc" "lacaml_Sdot_stub"
...
external direct_lansy :
  ...
  a : mat ->
  work : vec
  -> float = "lacaml_Slansy_stub_bc" "lacaml_Slansy_stub"
...
external direct_lamch : char -> float = "lacaml_Slamch_stub"
...
external direct_orgqr :
  ...
  ac : int ->
  a : mat ->
  int = "lacaml_Sorgqr_stub_bc" "lacaml_Sorgqr_stub"
...
external direct_ormqr :
  ...
  cc : int ->
  c : mat ->
  int = "lacaml_Sormqr_stub_bc" "lacaml_Sormqr_stub"
...
external direct_gecon :
  ...
  norm : char ->
  anorm : float ->
  int * float = "lacaml_Sgecon_stub_bc" "lacaml_Sgecon_stub"
...
external direct_sycon :
  ...
  iwork : int_vec ->
  anorm : float ->
  int * float = "lacaml_Ssycon_stub_bc" "lacaml_Ssycon_stub"
...
external direct_gesvd :
  ...
  work : vec ->
  lwork : int
  -> int = "lacaml_Sgesvd_stub_bc" "lacaml_Sgesvd_stub"
...
external direct_gesdd :
  ...
  lwork : int ->
  iwork : int_vec
  -> int = "lacaml_Sgesdd_stub_bc" "lacaml_Sgesdd_stub"
...
external direct_geev :
  ...
  work : vec ->
  lwork : int
  -> int = "lacaml_Sgeev_stub_bc" "lacaml_Sgeev_stub"
...
external direct_syev :
  ...
  work : vec ->
  lwork : int
  -> int = "lacaml_Ssyev_stub_bc" "lacaml_Ssyev_stub"
...
external direct_syevd :
  ...
  iwork : int_vec ->
  liwork : int
  -> int = "lacaml_Ssyevd_stub_bc" "lacaml_Ssyevd_stub"
...
external direct_sbev :
  ...
  work : vec
  -> int = "lacaml_Ssbev_stub_bc" "lacaml_Ssbev_stub"
...
external direct_sygv :
  ...
  work : vec ->
  lwork : int
  -> int = "lacaml_Ssygv_stub_bc" "lacaml_Ssygv_stub"
...
external direct_sbgv :
  ...
  z : mat ->
  work : vec
  -> int = "lacaml_Ssbgv_stub_bc" "lacaml_Ssbgv_stub"
