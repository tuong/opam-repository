...
external direct_dotu :
  ...
  incx : int ->
  x : vec ->
  num_type = "lacaml_Cdotu_stub_bc" "lacaml_Cdotu_stub"
...
external direct_dotc :
  ...
  incx : int ->
  x : vec ->
  num_type = "lacaml_Cdotc_stub_bc" "lacaml_Cdotc_stub"
...
external direct_lansy :
  ...
  a : mat ->
  work : rvec ->
  float = "lacaml_Clansy_stub_bc" "lacaml_Clansy_stub"
...
external direct_gesvd :
  ...
  lwork : int ->
  rwork : rvec ->
  int = "lacaml_Cgesvd_stub_bc" "lacaml_Cgesvd_stub"
...
let gesvd_get_opt_lwork loc jobu jobvt m n ar ac a s ur uc u vtr vtc vt =
  ...
  in
  if info = 0 then int_of_float32 work.{1}.re
...
external direct_geev :
  ...
  lwork : int ->
  rwork : vec ->
  int = "lacaml_Cgeev_stub_bc" "lacaml_Cgeev_stub"
