...
external direct_ssqr_zero :
  ...
  incx : int ->
  x : vec ->
  num_type = "lacaml_Dssqr_zero_stub"
...
external direct_ssqr_diff :
  ...
  incy : int ->
  y : vec ->
  num_type = "lacaml_Dssqr_diff_stub_bc" "lacaml_Dssqr_diff_stub"
