...
module Vec : sig
  include module type of Vec2_D
  include module type of Vec4_D
end

module Mat : sig
  include module type of Mat2_D
  include module type of Mat4_D
end

include module type of Real_io

include module type of Impl2_D
include module type of Impl4_D
