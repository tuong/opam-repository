...
external direct_ssqr_zero :
  ...
  incx : int ->
  x : vec ->
  num_type = "lacaml_Sssqr_zero_stub"
...
external direct_neg :
  ...
  incx : int ->
  x : vec ->
  unit = "lacaml_Sneg_stub_bc" "lacaml_Sneg_stub"
...
external direct_add :
  ...
  incy : int ->
  y : vec ->
  unit = "lacaml_Sadd_stub_bc" "lacaml_Sadd_stub"
...
external direct_sub :
  ...
  incy : int ->
  y : vec ->
  unit = "lacaml_Ssub_stub_bc" "lacaml_Ssub_stub"
...
external direct_mul :
  ...
  incy : int ->
  y : vec ->
  unit = "lacaml_Smul_stub_bc" "lacaml_Smul_stub"
...
external direct_div :
  ...
  incy : int ->
  y : vec ->
  unit = "lacaml_Sdiv_stub_bc" "lacaml_Sdiv_stub"
...
external direct_ssqr_diff :
  ...
  incy : int ->
  y : vec ->
  num_type = "lacaml_Sssqr_diff_stub_bc" "lacaml_Sssqr_diff_stub"
