...
external direct_ssqr_zero :
  ...
  incx : int ->
  x : vec ->
  num_type = "lacaml_Cssqr_zero_stub"
...
external direct_neg :
  ...
  incx : int ->
  x : vec ->
  unit = "lacaml_Cneg_stub_bc" "lacaml_Cneg_stub"
...
external direct_add :
  ...
  incy : int ->
  y : vec ->
  unit = "lacaml_Cadd_stub_bc" "lacaml_Cadd_stub"
...
external direct_sub :
  ...
  incy : int ->
  y : vec ->
  unit = "lacaml_Csub_stub_bc" "lacaml_Csub_stub"
...
external direct_mul :
  ...
  incy : int ->
  y : vec ->
  unit = "lacaml_Cmul_stub_bc" "lacaml_Cmul_stub"
...
external direct_div :
  ...
  incy : int ->
  y : vec ->
  unit = "lacaml_Cdiv_stub_bc" "lacaml_Cdiv_stub"
...
external direct_ssqr_diff :
  ...
  incy : int ->
  y : vec ->
  num_type = "lacaml_Cssqr_diff_stub_bc" "lacaml_Cssqr_diff_stub"
