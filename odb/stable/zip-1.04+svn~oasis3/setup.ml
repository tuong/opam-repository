...
(* OASIS_START *)
(* DO NOT EDIT (digest: 56e98979662ee2afa9c125970bcc6599) *)
(*
     ...
     package =
       {
          ...
          homepage = Some "http://calendar.forge.ocamlcore.org/";
          synopsis =
            "Easy access to compressed files in ZIP, GZIP, JAR formats.";
          description = None;
          categories = [];
