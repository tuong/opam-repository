...
*)
#else
#warning "MSG_NOSIGNAL not defined; really_send_no_sigpipe unavailable"
#endif
...
*)
#else
#warning "MSG_NOSIGNAL not defined; send_nonblocking_no_sigpipe unavailable"
#endif
...
*)
#else
#warning "MSG_NOSIGNAL not defined; sendto_nonblocking_no_sigpipe unavailable"
#endif
...
*)
#else
#warning "MSG_NOSIGNAL not defined; sendmsg_nonblocking_no_sigpipe unavailable"
#endif
...
(** [unsafe_really_send_no_sigpipe sock ~pos ~len bstr]
    ...
    bounds checks.  Will crash on bounds errors! *)
#else
#warning "MSG_NOSIGNAL not defined; unsafe_really_send_no_sigpipe unavailable"
#endif
...
(** [unsafe_send_nonblocking_no_sigpipe sock ~pos ~len bstr] similar to
    ...
    bounds checks.  Will crash on bounds errors! *)
#else
#warning "MSG_NOSIGNAL not defined; unsafe_send_nonblocking_no_sigpipe unavailable"
#endif
...
val find : ?pos : int -> ?len : int -> int -> t -> int
(** [find ?pos ?len needle bstr] returns the position of the needle
    within bstr, as an offset from the start of the string.
    Returns -1 if needle doesn't exist in bstr.
